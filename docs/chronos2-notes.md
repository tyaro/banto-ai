...
- 未実施: origin／日／設備拡大、missing／stale／regime／fault slice、Chronos再実行の再現性、coverage calibration改善、cold／warmとmodel-only resourceの分離。TimesFM 3.0との同じMetroPT条件の比較は完了し、結果を[`results/timesfm3-metropt3-evaluation-2026-09-04.md`](results/timesfm3-metropt3-evaluation-2026-09-04.md)に記録した。Phase 2は未完了とする。
