...
状態: **2026-09-10の「お願いします」で見直し方針了承済み**。

具体的な選定・実装・限定検証は[互換性候補計画](anomaly-multiseed-v0.3-s4-b1-token-compatibility-plan-2026-09-10.md)へ記録する。
以下の未選定・方針判断待ちに相当する記述は判断前の履歴であり、この追記が優先する。
