...
状態: **了承済みの限定実機1回を実施済み / call_59e0候補値C0000022を取得 / 所有終了・証跡保存確認済み**。

実測は[bcrypt内部失敗値の結果](anomaly-multiseed-v0.3-s4-b1-bcrypt-failure-result-2026-09-10.md)を参照。以下は実行前に保存した計画。
