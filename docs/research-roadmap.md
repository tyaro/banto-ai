...
[`anomaly-multiseed-v0.3-s2-audit-2026-09-06.md`](results/anomaly-multiseed-v0.3-s2-audit-2026-09-06.md)に記録しています。GitHub Actions [run 34017895359](https://github.com/tyaro/banto-ai/actions/runs/34017895359)もsuccessでした。次はS3 deterministic runnerです。S2はformal run、
性能評価、promotionを意味せず、Linux正式受入やWindows native／DACL／AccessCheck受入も未実施です。S0の監査根拠は
