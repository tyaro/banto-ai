...
class DebugDriverTests(unittest.TestCase):
    ...
    def driver(self, stack, *, unload_entry=False, init_return=False, console_failure=False,
        ...
        return d.DebugDriver(unload_entry=unload_entry, init_return=init_return,
                             ...
                             bootstrap=bootstrap, init_failure=init_failure, bcrypt_failure=bcrypt_failure, bcrypt_detail=bcrypt_detail, bcrypt_device=bcrypt_device), api, kernel, preflight, tokens, fixture, disk
